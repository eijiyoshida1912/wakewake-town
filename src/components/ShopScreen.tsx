...
export default function ShopScreen({ coins, items, purchasedItem, onBuy, onDismissPurchase, onBack }: ShopScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-100 to-orange-100 flex flex-col">
      {/* モーダルが開いている間は、うしろのお店を操作できないようにする */}
      <div inert={purchasedItem !== null} className="flex flex-1 flex-col">
      ...
      {purchasedItem !== null && <PurchaseModal name={purchasedItem} onClose={onDismissPurchase} />}
    </div>
  )
}
